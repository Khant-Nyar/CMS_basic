        ...
        <div class="row">
            ...
            <?php 
                ...
                if(isset($_GET['post_id'])){
                    $post_id=mysql_real_escape_string($connect,$_GET['post_id']);
                    $post_count_query = "UPDATE posts SET post_view_count=post_view_count+1 WHERE post_id=$post_id";
                    mysqli_query($connect,$post_count_query); 
                }else{
            ...
            ?>
                ...
                <iframe src="https://www.pornhub.com/embed/ph5f0fcbbce3952" frameborder="0" width="560" height="340" scrolling="no" allowfullscreen></iframe>
                 </div>
